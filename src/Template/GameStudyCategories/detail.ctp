...
-->
          ...
          <div class="header__text2">
            ...
            <div>
              <span>
                <?php if($studyData['game_study_categories__is_downloaded'] == 0): ?>
                  <a href="<?= $this->Url->build(['controller'=>'gameStudyCategories', 'action'=>'download', $studyData['game_study_categories__game_course_category_id'], $studyData['game_study_categories__id'], 'contents']) ?>">
