<?php
$categoryStr = $studyData['business_course_categories__name'] . " ▶ " . $studyData['business_study_categories__name'];
?>
        ...
        <div class="study-contents__detail">
          ...
          <div class="detail__content">
            <form>
              ...
              <input type="hidden" name="business_study_category_id" id="business-study-category-id" value="<?= h($studyData['business_study_categories__id']) ?>" >
