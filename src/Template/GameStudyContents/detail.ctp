      ...
      <div class="study-categories__list">
        <div class="list__header categories-color__level--dg0">
          <div class="header__text1">
            <div>
              <span>Study<?= h($studyData['game_study_contents__level']) ?>.</span>&nbsp;&nbsp;
              <span>
                <?php
                    $sub_name = str_replace(",", " + ", $studyData['game_study_contents__sub_name'], $cnt);
                    echo h($sub_name);
                ?>
              </span>
            </div>
          ...
          <div class="header__text2">
            <h3><?= h($studyData['game_study_contents__name']) ?></h3>
            <div>
              <span></span>
            </div>
          </div>
